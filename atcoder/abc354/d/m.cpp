...
int main()
{
  ...
  if ((d - b) % 2 && d % 2 == 0)
  {
    ans = min(aa, cc) * (d - b + 1) * 2 + abs(a - c) / 4 * (d - b);
  }
  else
  {
    ans = min(aa, cc) * (d - b) * 2 + abs(a - c) / 4 * (d - b);
    }
  ll ans2 = 0;
  int f = 0;
  if (cc > aa)
  ...
  if (abs(a - c) % 4 == 1)
  {
    ...
    if (max(aa, cc) % 4 == 1 || max(aa, cc) % 4 == 2)
    {
      f++;
    }
  ...
  {
    if (max(aa, cc) % 4 == 1 || max(aa, cc) % 4 == 3)
    {
      ans2 += (d - b) * 2;
    }
    else if (max(aa, cc) % 4 == 0)
    {
      ans2 += (d - b) * 3;
    }
    else
  ...
  {
    ans2 += (d - b) * 2;
    if (max(aa, cc) % 4 == 0 || max(aa, cc) % 4 == 1)
    {
      f++;
    }
